{{ Form::open(['route' => 'property-contractors.store', 'class' => 'needs-validation', 'novalidate']) }}
<div class="modal-body">
    <div class="row">
        ...
        <x-mobile divClass="col-md-12" type="mobile_no" name="mobile_no" class="form-control"
            label="{{ __('Mobile Number') }}" placeholder="{{ __('Mobile Number') }}" value="" id="mobileField"
            required></x-mobile>
        <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-12">
            ...
            {{ Form::text('service_type', '', ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Service type')]) }}
        </div>
