    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('One Solution For All Your Property Management Needs')}}</h2>
                <p>{{__('Simplify property management tasks seamlessly with our comprehensive module, covering everything from tenant management  to maintenance requests and financial reporting.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('The Smartest Way To Manage Your Property Management')}}</h2>
                            <p>{{__('Transform property management into a streamlined process with our robust module, designed to handle property details, tenant relationships, lease agreements, and maintenance requests with ease.')}}</p>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Manage Key Tenant Matters Easily')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Create a profile for every tenant and track their key information, including property unit and document. Update and change their information in just a few clicks.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Lease Renewal')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('At the end of the lease term, the parties may choose to renew the lease, negotiate new terms, or terminate the lease according to the specified process.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Manage All Your Property Management Tasks Quickly And Easily From One Place')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Control and keep track of your invoices with ease. Enhance property oversight and maximize efficiency with our user-friendly Property Management Module, offering a centralized platform for lease management, rent collection, and property maintenance.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Manage Your Property Management From One Place')}}</h2>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Oprate a Fast and Easy Property Management process')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Make your property lease process fast and convenient for your tenants. select date of when you want to rent property and select the unit your tenants want to stay and after click on Book Now.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                ...
                                <div class="acnav-list">
                                    <p>{{__('Get paid for work done, fast. Integrate several payment options for diverse tenants and make the payment process stress-free. Easily safeguard your tenants’ payment by using Stripe, PayPal, Flutterwave, and more.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                ...
                                <div class="acnav-list">
                                    <p>{{__('Integrate the Twilio app and never miss an important notification again. Get notified when property unit booking are completed and get notifications about new property unit booking sent to your mobile phone via text.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Modify Vital Property Management Info With Ease')}}</h2>
                        </div>
                        <p>{{__('Modify and update your generated property management property units with ease. Add new property, unit and his details without stress. Property Management allows you to create and maintain the data of each tenant. You get access to all essential information through a well-maintained format.')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
            ...
            <div class="row row-gap align-items-center ">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        ...
                        <p>{{__('Optimize your property portfolio effortlessly using our Property Management Module, featuring intuitive tools for lease administration, tenant communication, and real-time performance analytics.')}}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="screenshot-section padding-top padding-bottom">
        <div class="container">
            ...
            <div class="screenshot-slider">
                ...
                <div class="screenshot-itm">
                    <div class="screenshot-image">
                        <a href="{{asset($path.'/image6.png')}}" target="_blank" class="img-zoom">
                            <img src="{{asset($path.'/image6.png')}}" alt="">
                        </a>
                    </div>
                </div>
                <div class="screenshot-itm">
